...
- CPPCR Exp. disciplinario 02-2026 (Tribunal de Honor)
- CPPCR Exp. 16-2025 (Fiscalía, archivado)
- Sala Constitucional 26-024427-0007-CO (amparo contra el CPPCR, finalizado)
- Sala Constitucional 26-000728-0007-CO (amparo previo, sin lugar)
- Sala Constitucional 26-007865-0007-CO (amparo contra Ministerio de Salud)
- Sala Constitucional 26-018306-0007-CO (acción de inconstitucionalidad, Decreto 40556-S)

## Evaluaciones vigentes

### E-001 — Penal por la frase (difamación / publicación de ofensas)

Viabilidad baja. La falta de individualización del redactor no impide dirigir la querella: el acta identifica a los seis directivos que votaron sin salvar voto [R-006] y la responsabilidad del acuerdo recae en quienes lo votan [N-001]. Los obstáculos son otros: la rectificación temprana funciona como retractación [R-009], el informe jurado habla de error sin intención [R-022] y el dolo individual es difícil de probar en un voto sin deliberación [R-007]. La Sala no descartó la vía penal; solo dijo que no le correspondía [R-024]. Plazo de reserva [N-004].

> Advertencia: N-001 está POR VERIFICAR. N-004 está POR VERIFICAR.

### E-002 — Penal por no individualizar al redactor

No. Negarse a identificar al redactor, con base en una norma legal [N-002], no configura delito; la Sala lo calificó como cuestión de legalidad ordinaria, impugnable por vías administrativas o jurisdiccionales [R-025].

> Advertencia: N-002 está POR VERIFICAR.

### E-003 — Contencioso-administrativo

Viable y la vía más sólida. Dos objetos: (a) responsabilidad patrimonial del Colegio por la lesión al honor ya declarada por la Sala [R-023, R-024], con la permanencia posterior al acuerdo de supresión como agravante [R-018, R-021] y dos votos salvados favorables a la condena [R-023]; como la mayoría no condenó en abstracto, no cabe la ejecución del art. 179 CPCA y debe ser proceso ordinario; (b) nulidad parcial del Acuerdo 473 en cuanto negó informar la autoría, vía que la Sala dejó abierta [R-025]. Plazos [N-004].

> Advertencia: N-004 está POR VERIFICAR.
...
- R-012 — Secretaría JD: «el acta que permanece en la web es la versión final»
- N-001 — LGAP art. 57: responsabilidad de los miembros de órganos colegiados
...
- Una sola fuente: este archivo. Todo lo demás en generados/ se regenera con: python3 herramientas/registro.py generar
- No se borra: un registro corregido se reemplaza por otro con 'supersede' y 'razon'.
- Estados: VERIFICADO (cotejado contra la fuente citada en verificado_el), POR VERIFICAR (afirmación sin cotejo contra fuente primaria), PENDIENTE (falta el documento o la respuesta).
- Folio: vacío hasta tener expediente certificado.
- Antes de presentar un escrito: python3 herramientas/registro.py cotejo <escrito.md>
